...
from Qudurat.models import Password, StudentData
from os import urandom

dynamic_string = urandom(6)
...
def password_entry():
    ...
    return render_template("enterpassword.html")
...
def data_entry(string):
    ...
    if form.validate_on_submit():
        ...
        studen_data = StudentData(name=name, academic_number=academic_number, ID_number=ID_number, number_of_try=number_of_try, math_degree=math_degree, language_degree=language_degree, degrees_sum=degrees_sum)
